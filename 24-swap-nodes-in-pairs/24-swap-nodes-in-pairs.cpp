...
class Solution {
public:
  /*index takes direct position and returns the pointer to a specific index*/
  ...
  /*Handles edge cases of the Linked List*/
   ListNode* reverseBetween(ListNode* head, int left, int right)
  {
    ...
    ListNode* swapPairs(ListNode* head) {
      int k = 2;
      int number_of_iteration = length(head)/k;
      int left = 1;
      int right = k;
